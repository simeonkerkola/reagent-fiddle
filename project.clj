(defproject reagent-fiddle "0.1.0-SNAPSHOT"
  ...
  :ring {:handler reagent-fiddle.handler/app
         :uberwar-name "reagent-fiddle.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "reagent-fiddle.jar"
  :main reagent-fiddle.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "reagent-fiddle.core/mount-root"}
             :compiler
             {:main "reagent-fiddle.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
